...
parser.add_argument('-i', '--patch_index', help='patch index to start from - to link labellized images (default = 0)', required=False, default=0)
...
for idPatch in range(nPatches):
    ...
    imageFolder = os.path.join(patchFolder, 'images')
